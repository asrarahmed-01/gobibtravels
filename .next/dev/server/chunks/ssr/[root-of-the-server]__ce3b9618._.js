...
const fetchAttractions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('attractions/fetchAttractions', async ()=>{
...
function* fetchToursSaga() {
    try {
        console.log('🔥 SAGA: fetchToursSaga STARTED!');
        ...
        console.log('Firestore Count:', toursData.length);
        ...
        yield (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$redux$2d$saga$2f$core$2f$effects$2f$dist$2f$redux$2d$saga$2d$core$2d$effects$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["put"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slices$2f$toursSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchToursFailure"])(error.message));
        yield (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$redux$2d$saga$2f$core$2f$effects$2f$dist$2f$redux$2d$saga$2d$core$2d$effects$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["put"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$slices$2f$uiSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setLoading"])(false));
    }
}
function* watchFetchTours() {
    console.log('👀 SAGA: Watching for fetchTours...');
...
const __TURBOPACK__default__export__ = fetchToursSaga;
}),
...
;
;
// 🔥 SAGA MIDDLEWARE (runs once per store)
let sagaMiddleware;
let isSagaRunning = false;
const makeStore = ()=>{
    // Create middleware only once
    if (!sagaMiddleware) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ce3b9618._.js.map